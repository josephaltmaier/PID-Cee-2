...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='proto/bluetooth.proto',
  package='bluetooth',
  syntax='proto3',
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n\x15proto/bluetooth.proto\x12\tbluetooth\"\x1d\n\nHelloWorld\x12\x0f\n\x07message\x18\x01 \x01(\tb\x06proto3'
)
...
_HELLOWORLD = _descriptor.Descriptor(
  name='HelloWorld',
  full_name='bluetooth.HelloWorld',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='message', full_name='bluetooth.HelloWorld.message', index=0,
...
HelloWorld = _reflection.GeneratedProtocolMessageType('HelloWorld', (_message.Message,), {
  ...
  '__module__' : 'proto.bluetooth_pb2'
  # @@protoc_insertion_point(class_scope:bluetooth.HelloWorld)
  })
